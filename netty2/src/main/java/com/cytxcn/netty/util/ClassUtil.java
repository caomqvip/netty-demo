...
public class ClassUtil {
     ...
     * @return
     */
    public static Set<Class<?>> getAllSubclasses(String scanPackage, Class<?> parent) {
     ...
     * @return
     */
    public static <A extends Annotation> Set<Class<?>> getClassesWithAnnotation(String scanPackage,
                                                                                 Class<A> annotation) {
